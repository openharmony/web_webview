...
public:
    ...
    MOCK_METHOD1(ExcludePickerWindows, int32_t(std::vector<int32_t>&));
    MOCK_METHOD1(AddWhiteListWindows, int32_t(const std::vector<uint64_t>&));
    MOCK_METHOD1(RemoveWhiteListWindows, int32_t(const std::vector<uint64_t>&));
    MOCK_METHOD1(SetPickerMode, int32_t(PickerMode));
