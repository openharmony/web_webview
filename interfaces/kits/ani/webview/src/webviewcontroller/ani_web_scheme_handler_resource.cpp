...
{
    WVLOG_D("Enter aniwebResourceHandler JSDidReceiveResponse");
    if (env == nullptr) {
...
{
    WVLOG_D("Enter aniwebResourceHandler JsDidFinish");
    if (env == nullptr) {
        WVLOG_E("env is nullptr");
        return;
    }
...
{
    WVLOG_D("WebResourceHandler WebResourceHandler native Constructor");
    if (env == nullptr) {
        WVLOG_E("env is nullptr");
        return;
    }
