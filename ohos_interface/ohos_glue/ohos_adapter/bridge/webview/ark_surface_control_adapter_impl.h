...
#ifndef ARK_SURFACE_CONTROL_ADAPTER_IMPL_H
#define ARK_SURFACE_CONTROL_ADAPTER_IMPL_H
#pragma once
...
class ArkSurfaceControlAdapterImpl : public ArkSurfaceControlAdapter {
public:
    explicit ArkSurfaceControlAdapterImpl(NWeb::SurfaceControlAdapter&);
    ...
    OHOS::NWeb::SurfaceControlAdapter& real_;

    IMPLEMENT_REFCOUNTING(ArkSurfaceControlAdapterImpl);
};

class ArkSurfaceTransactionAdapterImpl : public ArkSurfaceTransactionAdapter {
public:
    explicit ArkSurfaceTransactionAdapterImpl(NWeb::SurfaceTransactionAdapter&);
    ...
    void SetOnComplete(void* transaction, void* context, void* func) override;
    ...
    void SetFrame(void* transaction, void* surfaceControl, float x, float y, float w, float h) override;
    ...
    OHOS::NWeb::SurfaceTransactionAdapter& real_;

    IMPLEMENT_REFCOUNTING(ArkSurfaceTransactionAdapterImpl);
};

} // namespace OHOS::ArkWeb

#endif // ARK_SURFACE_CONTROL_ADAPTER_IMPL_H