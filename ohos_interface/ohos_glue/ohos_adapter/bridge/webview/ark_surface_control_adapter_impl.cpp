...
void* ArkSurfaceControlAdapterImpl::FromNativeWindow(void* parent, const char* name)
{
    return real_.FromNativeWindow(parent, name);
}
...
void ArkSurfaceControlAdapterImpl::SetWindowNodeIdAndRSHandle(void* nativeWindow, uint64_t nodeId, uintptr_t handle)
{
...
void* ArkSurfaceTransactionAdapterImpl::Create()
{
    return real_.Create();
}
...
void ArkSurfaceTransactionAdapterImpl::SetFrame(
    void* transaction, void* surfaceControl, float x, float y, float w, float h)
{
    real_.SetFrame(transaction, surfaceControl, x, y, w, h);
}
...
void ArkSurfaceTransactionAdapterImpl::SetScale(
    void* transaction, void* surfaceControl, float scaleX, float scaleY, float scaleZ)
{
    real_.SetScale(transaction, surfaceControl, scaleX, scaleY, scaleZ);
}
...
void ArkSurfaceTransactionAdapterImpl::SetBorderStyle(void* transaction, void* surfaceControl,
