...
ArkBackgroundStateChangeCallbackAdapterImpl::ArkBackgroundStateChangeCallbackAdapterImpl(
    std::shared_ptr<OHOS::NWeb::BackgroundStateChangeCallbackAdapter> ref)
    : real_(ref)
{}
