...
std::unique_ptr<NWeb::CertManagerAdapter> ArkOhosAdapterHelperWrapper::GetCertManagerAdapter()
{
    ArkWebRefPtr<ArkCertManagerAdapter> adapter = ctocpp_->GetCertManagerAdapter();
...
std::unique_ptr<NWeb::BackgroundTaskAdapter> ArkOhosAdapterHelperWrapper::CreateBackgroundTaskAdapter()
{
    ArkWebRefPtr<ArkBackgroundTaskAdapter> adapter = ctocpp_->CreateBackgroundTaskAdapter();
...
std::unique_ptr<NWeb::VpeVideoAdapter> ArkOhosAdapterHelperWrapper::CreateVpeVideoAdapter()
{
    ArkWebRefPtr<ArkVpeVideoAdapter> adapter = ctocpp_->CreateVpeVideoAdapter();
