...
public:
    /*--ark web()--*/
    virtual void* FromNativeWindow(void* parent, const char* name) = 0;

    /*--ark web()--*/
    virtual void* Create(const char* name) = 0;

    /*--ark web()--*/
    virtual void Release(void* surface_control) = 0;

    /*--ark web()--*/
    virtual void SetWindowNodeIdAndRSHandle(void* native_window, uint64_t node_id, uintptr_t handle) = 0;
};
...
public:
    ...
    /*--ark web()--*/
    virtual void Reparent(void* transaction, void* surface_control, void* new_parent) = 0;

    /*--ark web()--*/
    virtual void SetVisibility(void* transaction, void* surface_control, int8_t visibility) = 0;

    /*--ark web()--*/
    virtual void SetZOrder(void* transaction, void* surface_control, int32_t z_order) = 0;

    /*--ark web()--*/
    virtual void SetBuffer(void* transaction, void* surface_control, void* buffer, int acquire_fence_fd, void* context,
        void* func) = 0;

    /*--ark web()--*/
    virtual void SetBounds(void* transaction, void* surface_control, float x, float y, float w, float h) = 0;

    /*--ark web()--*/
    virtual void SetFrame(void* transaction, void* surface_control, float x, float y, float w, float h) = 0;

    /*--ark web()--*/
    virtual void SetPivot(void* transaction, void* surface_control, float x, float y) = 0;

    /*--ark web()--*/
    virtual void SetBufferTransform(void* transaction, void* surface_control, int32_t transform) = 0;

    /*--ark web()--*/
    virtual void SetScale(void* transaction, void* surface_control, float scaleX, float scaleY, float scaleZ) = 0;

    /*--ark web()--*/
    virtual void SetTranslate(
        void* transaction, void* surface_control, float translateX, float translateY, float translateZ) = 0;

    /*--ark web()--*/
    virtual void SetDamageRegion(void* transaction, void* surface_control, const void* rects, uint32_t count) = 0;

    /*--ark web()--*/
    virtual void SetBufferAlpha(void* transaction, void* surface_control, float alpha) = 0;

    /*--ark web()--*/
    virtual void SetForegroundColor(
        void* transaction, void* surface_control, float red, float green, float blue, float alpha) = 0;
    ...
    virtual void SetBorderWidth(
        void* transaction, void* surface_control, float left, float top, float right, float bottom) = 0;

    /*--ark web()--*/
    virtual void SetBorderStyle(
        void* transaction, void* surface_control, uint32_t left, uint32_t top, uint32_t right, uint32_t bottom) = 0;

    /*--ark web()--*/
    virtual void SetHardwareEnableHint(void* transaction, void* surface_control, bool enable) = 0;

    /*--ark web()--*/
    virtual void SetName(void* transaction, void* surface_control, const char* name) = 0;

    /*--ark web()--*/
    virtual void SetFrameGravity(void* transaction, void* surface_control, int32_t gravity) = 0;

    /*--ark web()--*/
    virtual void SetSrcRect(void* transaction, void* surface_control, float x, float y, float w, float h) = 0;

    /*--ark web()--*/
    virtual void SetDisplayRect(void* transaction, void* surface_control, float x, float y, float w, float h) = 0;

    /*--ark web()--*/
    virtual void ClearBufferQueueCache(void* transaction, void* surface_control, bool cleanAll) = 0;
};
} // namespace OHOS::ArkWeb
