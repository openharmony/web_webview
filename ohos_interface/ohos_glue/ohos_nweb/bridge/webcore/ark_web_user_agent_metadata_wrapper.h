...
#ifndef ARK_WEB_USER_AGENT_METADATA_WRAPPER_H_
#define ARK_WEB_USER_AGENT_METADATA_WRAPPER_H_
#pragma once
...
class ArkWebUserAgentMetadataWrapper : public OHOS::NWeb::NWebUserAgentMetadata {
public:
    ArkWebUserAgentMetadataWrapper(ArkWebRefPtr<ArkWebUserAgentMetadata> ark_web_user_agent_metadata);
    ~ArkWebUserAgentMetadataWrapper() = default;
...
private:
    ArkWebRefPtr<ArkWebUserAgentMetadata> ark_web_user_agent_metadata_;
};

} // namespace OHOS::ArkWeb

#endif // ARK_WEB_USER_AGENT_METADATA_WRAPPER_H_
