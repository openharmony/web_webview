...
#ifndef ARK_WEB_USER_AGENT_METADATA_ACK_IMPL_H_
#define ARK_WEB_USER_AGENT_METADATA_ACK_IMPL_H_
#pragma once
...
class ArkWebUserAgentMetadataAckImpl : public ArkWebUserAgentMetadataAck {
    IMPLEMENT_REFCOUNTING(ArkWebUserAgentMetadataAck);

public:
    ArkWebUserAgentMetadataAckImpl(std::shared_ptr<OHOS::NWeb::NWebUserAgentMetadata> nweb_user_agent_metadata);
    ~ArkWebUserAgentMetadataAckImpl() = default;
