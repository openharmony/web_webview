...
ArkWebUserAgentMetadataAckImpl::ArkWebUserAgentMetadataAckImpl(
...
void ArkWebUserAgentMetadataAckImpl::SetBrandVersionList(
...
void ArkWebUserAgentMetadataAckImpl::SetArchitecture(const ArkWebString& arch)
{
    nweb_user_agent_metadata_->SetArchitecture(ArkWebStringStructToClass(arch));
}
 
void ArkWebUserAgentMetadataAckImpl::SetBitness(const ArkWebString& bitness)
{
    nweb_user_agent_metadata_->SetBitness(ArkWebStringStructToClass(bitness));
}
 
void ArkWebUserAgentMetadataAckImpl::SetFormFactors(const ArkWebStringVector& formFactors)
{
    nweb_user_agent_metadata_->SetFormFactors(ArkWebStringVectorStructToClass(formFactors));
}
 
void ArkWebUserAgentMetadataAckImpl::SetFullVersion(const ArkWebString& fullVersion)
{
    nweb_user_agent_metadata_->SetFullVersion(ArkWebStringStructToClass(fullVersion));
}
 
void ArkWebUserAgentMetadataAckImpl::SetMobile(const bool isMobile)
{
    nweb_user_agent_metadata_->SetMobile(isMobile);
}
 
void ArkWebUserAgentMetadataAckImpl::SetModel(const ArkWebString& model)
{
    nweb_user_agent_metadata_->SetModel(ArkWebStringStructToClass(model));
}
 
void ArkWebUserAgentMetadataAckImpl::SetPlatform(const ArkWebString& platform)
{
    nweb_user_agent_metadata_->SetPlatform(ArkWebStringStructToClass(platform));
}
 
void ArkWebUserAgentMetadataAckImpl::SetPlatformVersion(const ArkWebString& platformVersion)
{
    nweb_user_agent_metadata_->SetPlatformVersion(ArkWebStringStructToClass(platformVersion));
}
 
void ArkWebUserAgentMetadataAckImpl::SetWow64(const bool isWow64)
{
    nweb_user_agent_metadata_->SetWow64(isWow64);
}

void ArkWebUserAgentMetadataAckImpl::GetBrandVersionList(
