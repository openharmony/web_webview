...
void ArkWebHandlerImpl::OnCameraCaptureStateChanged(int originalState, int newState)
{
...
void ArkWebHandlerImpl::OnMediaCastEnter()
{
...
bool ArkWebHandlerImpl::OnNestedScrollV2(float& x, float& y)
{
