...
#ifndef ARK_WEB_AGENT_MANAGER_WRAPPER_H_
#define ARK_WEB_AGENT_MANAGER_WRAPPER_H_
#pragma once
...
class ArkWebAgentManagerWrapper : public OHOS::NWeb::NWebAgentManager {
public:
    ArkWebAgentManagerWrapper(ArkWebRefPtr<ArkWebAgentManager> ark_web_agent_manager);
    ~ArkWebAgentManagerWrapper() = default;
