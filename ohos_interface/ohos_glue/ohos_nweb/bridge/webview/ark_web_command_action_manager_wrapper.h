...
#ifndef ARK_WEB_COMMAND_ACTION_MANAGER_WRAPPER_H_
#define ARK_WEB_COMMAND_ACTION_MANAGER_WRAPPER_H_
#pragma once
...
class ArkWebCommandActionManagerWrapper : public OHOS::NWeb::NWebCommandActionManager {
public:
    ArkWebCommandActionManagerWrapper(ArkWebRefPtr<ArkWebCommandActionManager> ark_web_command_action_manager);
    ~ArkWebCommandActionManagerWrapper() = default;
     ...
     */
    int32_t HandleInputCommand(std::shared_ptr<OHOS::NWeb::NWebCommandActionInfo> info) override;
     ...
     * @return The result of command. 0 on success, negative error code on failure.
     */
    int32_t HandleSelectCommand(std::shared_ptr<OHOS::NWeb::NWebCommandActionInfo> info) override;
...
#endif  // ARK_WEB_COMMAND_ACTION_MANAGER_WRAPPER_H_
