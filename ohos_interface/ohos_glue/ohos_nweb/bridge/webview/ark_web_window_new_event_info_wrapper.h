...
#ifndef ARK_WEB_WINDOW_NEW_EVENT_INFO_WRAPPER_H_
#define ARK_WEB_WINDOW_NEW_EVENT_INFO_WRAPPER_H_
#pragma once
...
using ArkWebNavigationPolicy = OHOS::NWeb::NavigationPolicy;

class ArkWebWindowNewEventInfoWrapper : public OHOS::NWeb::NWebWindowNewEventInfo {
public:
    ArkWebWindowNewEventInfoWrapper(ArkWebRefPtr<ArkWebWindowNewEventInfo> ark_web_window_new_event_info);
    ~ArkWebWindowNewEventInfoWrapper() = default;
     ...
     */
    std::shared_ptr<OHOS::NWeb::NWebControllerHandler> GetHandler() override;
     ...
     */
    ArkWebNavigationPolicy GetNavigationPolicy() override;

private:
    ArkWebRefPtr<ArkWebWindowNewEventInfo> ark_web_window_new_event_info_;
};

} // namespace OHOS::ArkWeb

#endif // #define ARK_WEB_WINDOW_NEW_EVENT_INFO_WRAPPER_H_
