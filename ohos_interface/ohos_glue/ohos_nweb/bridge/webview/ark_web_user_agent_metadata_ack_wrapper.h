...
#ifndef ARK_WEB_USER_AGENT_METADATA_ACK_WRAPPER_H_
#define ARK_WEB_USER_AGENT_METADATA_ACK_WRAPPER_H_
#pragma once
...
class ArkWebUserAgentMetadataAckWrapper : public OHOS::NWeb::NWebUserAgentMetadata {
public:
    ArkWebUserAgentMetadataAckWrapper(ArkWebRefPtr<ArkWebUserAgentMetadataAck> ark_web_user_agent_metadata);
    ~ArkWebUserAgentMetadataAckWrapper() = default;

    void SetBrandVersionList(const std::vector<std::string>& brand, const std::vector<std::string>& majorVersion,
        const std::vector<std::string>& fullVersion) override;
    ...
    void GetBrandVersionList(std::vector<std::string>& brand, std::vector<std::string>& majorVersion,
        std::vector<std::string>& fullVersion) override;
...
private:
    ArkWebRefPtr<ArkWebUserAgentMetadataAck> ark_web_user_agent_metadata_;
};

} // namespace OHOS::ArkWeb
 
#endif // ARK_WEB_USER_AGENT_METADATA_ACK_WRAPPER_H_