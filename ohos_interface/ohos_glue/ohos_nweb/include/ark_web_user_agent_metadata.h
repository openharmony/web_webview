...
#ifndef ARK_WEB_USER_AGENT_METADATA_H_
#define ARK_WEB_USER_AGENT_METADATA_H_
#pragma once
...
class ArkWebUserAgentMetadata : public virtual ArkWebBaseRefCounted {
public:
    /*--ark web()--*/
...
#endif // ARK_WEB_USER_AGENT_METADATA_H_
