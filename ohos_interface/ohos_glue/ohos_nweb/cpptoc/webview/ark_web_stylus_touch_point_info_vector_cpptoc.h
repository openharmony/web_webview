...
#ifndef ARK_WEB_STYLUS_TOUCH_POINT_INFO_VECTOR_CPPTOC_H_
...
void ArkWebStylusTouchPointInfoVectorStructRelease(ArkWebStylusTouchPointInfoVector& struct_value);

} // namespace OHOS::ArkWeb

#endif // ARK_WEB_STYLUS_TOUCH_POINT_INFO_VECTOR_CPPTOC_H_
