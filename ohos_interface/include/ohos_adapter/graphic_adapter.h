...
public:
    ...
    virtual void SetWindowNodeIdAndRSHandle(void* nativeWindow, uint64_t nodeId, uintptr_t handle) = 0;
};
...
public:
    ...
    virtual void SetFrame(void* transaction, void* surfaceControl, float x, float y, float w, float h) = 0;
    ...
    virtual void SetScale(void* transaction, void* surfaceControl, float scaleX, float scaleY, float scaleZ) = 0;
