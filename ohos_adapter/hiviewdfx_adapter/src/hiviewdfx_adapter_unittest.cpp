...
namespace OHOS::NWeb {
class HiViewDFXAdapterTest : public testing::Test {
protected:
    HiViewDFXAdapterTest() {}

    ~HiViewDFXAdapterTest() override {}
 ...
 * @tc.type: FUNC.
 */
TEST(HiViewDFXAdapterTest, NormalScene)
{
 ...
 * @tc.type: FUNC 01.
 */
TEST(HiViewDFXAdapterTest, NormalScene_01)
{
