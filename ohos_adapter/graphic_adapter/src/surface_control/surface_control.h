...
public:
    ...
    void SetPerspective(float perspX, float perspY, float perspZ, float perspW);
    void SetBufferTransparency(int32_t transparency);
    void SetDamageRegion(std::vector<Rect> rects);
    void SetBufferAlpha(float alpha);
    void SetFrameRateWithChangeStrategy(float frame_rate, int8_t compatibility, int32_t strategy);
    void ClearFrameRate();
